    ...
    return (
        <div className="grid grid-cols-12 w-full gap-6 select-none cursor-pointer">
            {product.map((item, idx) => (
                <div onClick={() => onAdd(item)} className="col-span-4 bg-[var(--color-base-dark-2)] rounded-lg text-center translate-y-[66px] h-[calc(100%-66px)] py-6 px-4" key={idx} role="button">
